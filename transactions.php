...
<body>
  ...
  <a href="#" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-teal" title="Search"><form method="POST"><button class="w3-hide-small" name="logout" title="Notifications">LOGOUT</button></form></a>
    ...
    ?>
	<table class="table" >
    <tr><td = colspan="6"><h1><B>TRANSACTIONS</B></h1></td></tr>
      <tr >
        <td><h4>TRANSACTION No.</h4> </td>
        <td><h4>BENEFICIARY ACCOUNT</h4></td>
        <td><h4>DATE</h4></td>
        <td><h4>AMOUNT</h4></td>
      </tr> 
      <?php
        ...
        { 
          ...
          <tr>
            ...
            <td><?php echo $row["beneficiaryaccount"]; ?></td>
...
<hr><hr>
  <a href="transfermoney.php"><h1 style="color: darkblue">MAKE A TRANSACTION</h1></a><br>
