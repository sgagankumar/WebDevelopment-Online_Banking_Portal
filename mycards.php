...
<body>
  ...
  <a href="" onclick="document.getElementById('id01').style.display='block'" class="w3-bar-item w3-button w3-hide-small w3-hover-white">APPLY FOR NEW ACCOUNT</a>
...
<hr>
<div>
  <h3>APPLY FOR NEW CREDIT CARDS <a>Click here..!!</a></h3>
